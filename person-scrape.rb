...
link_page = @browser.as(:css => ".button.mini.primary.contest-enter")
link_page.each do |a|
  debugger
  @browser.goto a.href
  random_wait_medium
...
#     if @browser.element(:class => "contest-entry-fee-container").exists?
#       div_tag = @browser.element(:class => "contest-entry-fee-container").exists?
